...
class EmailSignInFormBlocBased extends StatefulWidget
  ...
  static Widget create(BuildContext context) {
    ...
    return Provider<EmailSignInBlog>(
      create: (context) => EmailSignInBlog(auth: auth),
      child: Consumer<EmailSignInBlog>(
...
class _EmailSignInFormBlocBasedState extends State<EmailSignInFormBlocBased> {
  ...
  void _emailEditingComplete(EmailSignInModel model) {
    final nextFocus = widget.emailValidator.isValid(model.email)
        ? _passwordFocusNode
        : _emailFocusNode;
  ...
  List<Widget> _buildChildren(EmailSignInModel model) {
    ...
    bool _submitEnable = widget.emailValidator.isValid(model.email) &&
